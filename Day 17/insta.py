...
insta_login(browser)  # login into instagram
...
def click_to_follow(browser):
    # my_follow_anchor_xpath = (
    #     "//a[contains(text(),'Follow')][not(contains(text(),'Following'))]"
    # )
    # my_follow_btn_xpath = (
    #     "//button[contains(text(),'Follow')][not(contains(text(),'Following'))]"
    # )
...
# my_login_btn_xpath = "//button[contains(text(),'Log In')]"
# login_btn_element = browser.find_element_by_xpath(my_login_btn_xpath)
# login_btn_element.click()

# time.sleep(2)

# insta_login(browser)  # instagram wants me to login again

# my_save_info_btn_xpath = "//button[contains(text(),'Save Info')]"
# info_btn_element = browser.find_element_by_xpath(my_save_info_btn_xpath)
# info_btn_element.click()

# new_user_url = "https://www.instagram.com/ted/"
# browser.get(new_user_url)
# click_to_follow(browser)  # follow ted on instagram
...
scrape_and_save(images_els)  # scrape and parse image elements

# scrape_and_save(video_els)  # scrape and parse video elements
